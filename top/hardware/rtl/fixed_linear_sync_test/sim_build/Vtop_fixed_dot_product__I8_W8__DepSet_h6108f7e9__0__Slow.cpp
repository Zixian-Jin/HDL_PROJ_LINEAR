...
VL_ATTR_COLD void Vtop_fixed_dot_product__I8_W8___stl_sequent__TOP__fixed_linear_sync_top__DOT__fc1_inst__DOT__linear__BRA__0__KET____DOT__fdp_inst__0(Vtop_fixed_dot_product__I8_W8* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_fixed_dot_product__I8_W8___stl_sequent__TOP__fixed_linear_sync_top__DOT__fc1_inst__DOT__linear__BRA__0__KET____DOT__fdp_inst__0\n"); );
    // Init
...
VL_ATTR_COLD void Vtop_fixed_dot_product__I8_W8___stl_sequent__TOP__fixed_linear_sync_top__DOT__fc1_inst__DOT__linear__BRA__1__KET____DOT__fdp_inst__0(Vtop_fixed_dot_product__I8_W8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_fixed_dot_product__I8_W8___stl_sequent__TOP__fixed_linear_sync_top__DOT__fc1_inst__DOT__linear__BRA__1__KET____DOT__fdp_inst__0\n"); );
    // Init
    CData/*1:0*/ fixed_vector_mult_inst__DOT____Vcellinp__join_inst__data_in_valid;
    fixed_vector_mult_inst__DOT____Vcellinp__join_inst__data_in_valid = 0;
    // Body
...
VL_ATTR_COLD void Vtop_fixed_dot_product__I8_W8___ctor_var_reset(Vtop_fixed_dot_product__I8_W8* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vtop_fixed_dot_product__I8_W8___ctor_var_reset\n"); );
    // Body
