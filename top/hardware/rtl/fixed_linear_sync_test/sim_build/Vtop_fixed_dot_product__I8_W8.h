...
#ifndef VERILATED_VTOP_FIXED_DOT_PRODUCT__I8_W8_H_
#define VERILATED_VTOP_FIXED_DOT_PRODUCT__I8_W8_H_  // guard

#include "verilated.h"

class Vtop__Syms;

class Vtop_fixed_dot_product__I8_W8 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vtop_fixed_dot_product__I8_W8(Vtop__Syms* symsp, const char* v__name);
    ~Vtop_fixed_dot_product__I8_W8();
    VL_UNCOPYABLE(Vtop_fixed_dot_product__I8_W8);
